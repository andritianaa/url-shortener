...
import { Shield, Users, LinkIcon, BarChart3, Trash2, Ban, UserCheck, Eye, UserPlus, Key } from "lucide-react"
...
export default function AdminPage() {
  ...
  const fetchData = async () => {
    try {
      const [usersResponse, statsResponse, linksResponse] = await Promise.all([
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `L'utilisateur a été ${isActive ? "activé" : "banni"} avec succès`,
        })
      } else {
        const error = await response.json()
        throw new Error(error.error)
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Gestion des utilisateurs et des liens</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+{stats.linksToday} aujourd'hui</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+{stats.clicksToday} aujourd'hui</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Moyenne par lien</CardTitle>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          {!user.isActive && <Badge variant="destructive">Banni</Badge>}
                        </div>
                  ...
                  <div key={link.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2 mb-2">
                          <h3 className="font-medium truncate">{link.description || link.shortCode}</h3>
                          {!link.isActive && <Badge variant="secondary">Inactif</Badge>}
                        </div>
                        <div className="space-y-1 text-sm text-muted-foreground">
                          <p className="font-mono bg-muted px-2 py-1 rounded inline-block">/{link.shortCode}</p>
                          <p className="truncate">→ {link.originalUrl}</p>
                          <div className="flex items-center space-x-4 text-xs">
                            <span>Par {link.userName}</span>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">Création de lien</p>
                      <p className="text-sm text-muted-foreground">Jean Dupont a créé le lien /abc123</p>
                    </div>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Marie Martin s'est inscrite</p>
                    </div>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">Suppression de lien</p>
                      <p className="text-sm text-muted-foreground">Admin a supprimé le lien /xyz789</p>
                    </div>
      ...
      <Dialog open={changePasswordOpen} onOpenChange={setChangePasswordOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Modifier le mot de passe de {selectedUser?.name || selectedUser?.email}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
          ...
          <DialogFooter>
            ...
            <Button onClick={changeUserPassword}>Changer le mot de passe</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
